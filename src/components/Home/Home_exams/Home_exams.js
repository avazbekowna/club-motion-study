...
import examsGirlImg from "./../../../img/Home-exams-girl2.png";
import examImg2 from "./../../../img/examscreen1.png";
import examImg3 from "./../../../img/Home-exams3.svg";
import examImg4 from "./../../../img/Home-exams4.svg";
                        ...
                        <div className="exams-group">
                            <div className="exams-group_block">
                                ...
                                <div className="exams-group_block-desc">
                                    ...
                                    <NavLink className="exams-group_block-desc_link" to={"/Discover-more"}>Discover more</NavLink>
                                </div>
                            </div>
                            <div className="exams-group_blocks">
                                <div className="exams-group_blocks-block">
                                    ...
                                    <div className="exams-group_blocks-block_desc">
                                        <NavLink to={"/Aptis"} className="exams-group_blocks-block_desc-link">aptis</NavLink>
                                ...
                                <div className="exams-group_blocks-block">
                                    ...
                                    <div className="exams-group_blocks-block_desc">
                                        <NavLink to={"/Ielts"} className="exams-group_blocks-block_desc-link">iELTS</NavLink>
                                ...
                                <div className="exams-group_blocks-block">
                                    ...
                                    <div className="exams-group_blocks-block_desc">
                                        <NavLink to={"/Other-exams"} className="exams-group_blocks-block_desc-link">other exams</NavLink>
